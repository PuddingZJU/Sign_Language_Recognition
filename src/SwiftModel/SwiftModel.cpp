...
: m_nCurrentFrameNo(0), m_nMaxFrameNo(0), m_pFbxSdkManager(NULL), m_pFbxScene(NULL), m_nCurrentTakeIndex(0), m_bJointMapping(false), m_pLeftGlove(NULL), m_pRightGlove(NULL)
{
